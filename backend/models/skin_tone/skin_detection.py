...
def cluster_matrix(dframe, dframe_removed, skin_cluster_label, height, width):
    ...
    dframe = pd.concat([dframe, dframe_removed], ignore_index=True, sort=False)
...
# print(skin_detection("ML/Skin_metrics/Skin_tone/public/test images/Optimized-selfieNig-cropped.jpg"))
# #ML\Skin_metrics\Skin_tone\public\test images\Optimized-selfieNig-cropped.jpg
# print("done")