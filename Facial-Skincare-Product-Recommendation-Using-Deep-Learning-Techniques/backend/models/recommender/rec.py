...
df2 = pd.read_csv('backend/models/recommender/final.csv')
makeup = pd.read_csv('backend/models/recommender/makeup_final.csv')
entries = len(df2)
...
# print(makeup_recommendation('all','light to medium'))
